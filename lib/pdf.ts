...
<head>
  ...
  <style>
    ...
    .header-title { font-size: 20px; font-weight: 700; color: #ffffff; letter-spacing: 0.01em; }
    .header-period { font-size: 15px; font-weight: 600; color: rgba(255,255,255,0.85); margin-top: 4px; }
    .header-sub { font-size: 11px; color: rgba(255,255,255,0.6); margin-top: 8px; line-height: 1.6; }
    .content { padding: 32px; }
...
<body>
  <div class="header-band">
    ...
    <div class="header-right">
      <div class="header-title">Annual Payment Summary</div>
      <div class="header-period">${year}</div>
      <div class="header-sub"><strong style="color:rgba(255,255,255,0.85)">${tenant.tenant_name}</strong><br/>Flat ${tenant.flat_no} · ${property.name}, ${property.city}</div>
    </div>
  </div>
